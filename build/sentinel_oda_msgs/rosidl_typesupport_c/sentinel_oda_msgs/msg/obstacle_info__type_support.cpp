...
static const _ObstacleInfo_type_support_symbol_names_t _ObstacleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sentinel_oda_msgs, msg, ObstacleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sentinel_oda_msgs, msg, ObstacleInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sentinel_oda_msgs, msg, ObstacleInfo)() {
  return &::sentinel_oda_msgs::msg::rosidl_typesupport_c::ObstacleInfo_message_type_support_handle;
}
